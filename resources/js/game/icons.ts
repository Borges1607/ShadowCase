 ...
 * Ícones do jogo.
 *
 * O protótipo Figma usava lucide-react; o projeto usa @mui/icons-material.
 * Este módulo faz a ponte: os nomes semânticos do protótipo continuam valendo
 * no código das telas, e a troca de biblioteca fica isolada aqui.
 *
 * Preferimos as variantes `Outlined` — o traço fino combina com a estética
 * de dossiê datilografado.
 */
export { default as IconSearch } from '@mui/icons-material/Search';
export { default as IconEye } from '@mui/icons-material/VisibilityOutlined';
export { default as IconLock } from '@mui/icons-material/LockOutlined';
export { default as IconMapPin } from '@mui/icons-material/PlaceOutlined';
export { default as IconClock } from '@mui/icons-material/ScheduleOutlined';
export { default as IconAlert } from '@mui/icons-material/WarningAmberOutlined';
export { default as IconChevronRight } from '@mui/icons-material/ChevronRight';
export { default as IconChevronLeft } from '@mui/icons-material/ChevronLeft';
export { default as IconChevronUp } from '@mui/icons-material/KeyboardArrowUp';
...
export { default as IconAward } from '@mui/icons-material/MilitaryTechOutlined';
